...
[![GoDoc](https://pkg.go.dev/badge/github.com/BlackKeyZ/solana-go?status.svg)](https://pkg.go.dev/github.com/BlackKeyZ/solana-go@v1.8.4?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/BlackKeyZ/solana-go/releases)
[![Build Status](https://github.com/BlackKeyZ/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/BlackKeyZ/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/BlackKeyZ/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/BlackKeyZ/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/BlackKeyZ/solana-go)](https://goreportcard.com/report/github.com/BlackKeyZ/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/BlackKeyZ/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/BlackKeyZ/solana-go@v1.8.4
```
...
You can wait for a transaction confirmation using the `github.com/BlackKeyZ/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/BlackKeyZ/solana-go/programs/address-lookup-table"
	"github.com/BlackKeyZ/solana-go/rpc"
...
import (
  ...
  "github.com/BlackKeyZ/solana-go"
  "github.com/BlackKeyZ/solana-go/programs/system"
  "github.com/BlackKeyZ/solana-go/rpc"
  "github.com/BlackKeyZ/solana-go/text"
)
...
import (
  ...
  "github.com/BlackKeyZ/solana-go/rpc"
  "github.com/BlackKeyZ/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/BlackKeyZ/solana-go/programs/system"
  "github.com/BlackKeyZ/solana-go/rpc"
  confirm "github.com/BlackKeyZ/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/BlackKeyZ/solana-go/rpc/jsonrpc"
  "github.com/BlackKeyZ/solana-go/rpc/ws"
  "github.com/BlackKeyZ/solana-go/text"
)
...
import (
  ...
  "github.com/davecgh/go-spew/spew"
  bin "github.com/gagliardetto/binary"
  solana "github.com/BlackKeyZ/solana-go"
  "github.com/BlackKeyZ/solana-go/programs/token"
  "github.com/BlackKeyZ/solana-go/rpc"
)
